...
import styles from "./TheAction.module.css";
    ...
    <section className="action-page-container px-6 py-8 max-w-4xl mx-auto">
      ...
      <div className="action-description text-justify text-lg space-y-4">
        <p>
          ...
          contribute to the achievement of the general goals set by the National
          Recovery and Resilience Plan “Greece 2.0” (hereinafter “Greece 2.0”).
          Component 4.5 “Promote Research and Innovation”, which includes the
          present Action, aims to increase public and private investments for
          research and development (R&amp;D), strengthen connections between
          science and businesses and develop innovative infrastructures for
          R&amp;D. This will be achieved through a series of projects, as well
          as reforms, aiming to motivate innovative businesses to invest in the
          R&amp;D sector. Sub-action 1, in which RE.Nature Cities Project is
