  ...
  return (
    <section className={`${styles.projectOutlineContainer} px-6 pb-16`}>
      ...
      <article className={styles.workPackage}>
        <h2 id="work1" tabIndex={-1} className={styles.workPackageTitle}>
      ...
      <article className={styles.workPackage}>
        <h2 id="work2" tabIndex={-1} className={styles.workPackageTitle}>
      ...
      <article className={styles.workPackage}>
        <h2 id="work3" tabIndex={-1} className={styles.workPackageTitle}>
      ...
      <article className={styles.workPackage}>
        <h2
          id="work4"
          tabIndex={-1}
          className={styles.workPackageTitle}
          aria-label="Work Package 4: Experimental Assessment of Street Trees as Urban NBS"
        >
      ...
      <article className={styles.workPackage}>
        <h2 id="work5" tabIndex={-1} className={styles.workPackageTitle}>
      ...
      <article className={styles.workPackage}>
        <h2 id="work6" tabIndex={-1} className={styles.workPackageTitle}>
      ...
      <article className={styles.workPackage}>
        <h2 id="work7" tabIndex={-1} className={styles.workPackageTitle}>
